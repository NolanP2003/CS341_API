...
<body>
    ...
    <main>
        <section id="Dani's Bio">
            <div class="bio-title">Danielle Strausburger</div>
            <br>
            <div id="bio"> Danielle Strausburger is majoring in Computer Science, with a concentration in Web and Application 
                Design, plus a minor in Graphic Design, and intends to graduate in 2025.
        </section>
    </main>
</body>
